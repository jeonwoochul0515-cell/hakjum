...
{/* 재방문자 배너 */}
        ...
        <div className="mt-8">
          ...
          <FAQItem
            q="정말 무료인가요?"
            a="네, 완전 무료이고 회원가입도 필요 없어요. 개인정보도 일절 수집하지 않습니다."
          />
          <FAQItem
            q="AI 추천이 정확한가요?"
            a="커리어넷 공식 데이터와 대학별 입시요강을 기반으로 추천합니다. 최종 결정은 담임 선생님과 상담하시는 걸 추천드려요."
          />
          <FAQItem
            q="우리 학교도 있나요?"
            a="NEIS(교육행정정보시스템) 데이터를 실시간 연동하여 전국 고등학교를 지원합니다. 학교 검색 시 자동으로 개설과목을 불러옵니다."
          />
          <FAQItem
            q="고1도 사용할 수 있나요?"
            a="물론이죠! 고1 때 미리 확인해두면 2학년 과목 선택이 훨씬 수월해요. 오히려 일찍 할수록 좋아요."
          />
        </div>
