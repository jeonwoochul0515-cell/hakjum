...
export const popularMajors: Major[] = [
  ...
  },
  {
    ...
    universities: [
      ...
      { name: '경북대학교(로스쿨)', area: '경북' },
      { name: '전남대학교(로스쿨)', area: '전남' },
      { name: '충남대학교(로스쿨)', area: '대전' },
      { name: '전북대학교(로스쿨)', area: '전북' },
      { name: '제주대학교(로스쿨)', area: '제주' },
      { name: '강원대학교(로스쿨)', area: '강원' },
    ],
  ...
  },
  {
    ...
    universities: [
      ...
      { name: '경북대학교', area: '경북' },
      { name: '대구교육대학교', area: '대구' },
      { name: '전남대학교', area: '전남' },
      { name: '광주교육대학교', area: '광주' },
      { name: '충남대학교', area: '대전' },
      { name: '공주교육대학교', area: '충남' },
    ],
